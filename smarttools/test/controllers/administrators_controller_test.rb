...
class AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post :create, administrator: { apellido: @administrator.apellido, contrasena: @administrator.contrasena, correo: @administrator.correo, nombre: @administrator.nombre }
    end
  ...
  test "should update administrator" do
    patch :update, id: @administrator, administrator: { apellido: @administrator.apellido, contrasena: @administrator.contrasena, correo: @administrator.correo, nombre: @administrator.nombre }
    assert_redirected_to administrator_path(assigns(:administrator))
  end
