...
#   @contests = Contest.all
    adminConstest = Contest.where(administrator_id: current_user)
    if adminConstest
      @contests = Contest.where(administrator_id: current_user).all#.paginate(:page => params[:page], :per_page=>10)
    else 
      @contests = nil
    end
  end
