Delayed::Worker.configure do |config|
  # optional params:
  #config.aws_config = '/home/ubuntu/aws.yaml' # Specify the file location of the AWS configuration YAML if you're not using Rails and you want to use a YAML file instead of calling AWS.config
